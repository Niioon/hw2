...
oj_pigs = filter(iris_tible, supp == 'OJ')
...
mean_table = group_by(iris_tible, supp) %>% 
...
ggplot(iris_tible, aes(dose,len))+
  geom_count(aes(colour = supp))
...
The orange jiuce seems to yield better results on doese of 0.5 and 1.0.
Regarding doses of 2.0 there seems to be no difference.
